...
# Time: 2019/04/08
# Copyright 2019 AUEB Data Mining Group, Stamatis Outsios
# Time: 2019/05/20
"""
...
class NerProcessor(DataProcessor):
    ...
    def get_labels(self):
        ...
        return ['[PAD]', 'ADJ', 'ADP', 'ADV', 'AUX', 'CCONJ', 'DET', 'INTJ', 'NOUN', 'NUM', 'PART', 'PRON', 'PROPN', 'PUNCT', 'SCONJ', 'SYM', 'VERB', 'X', '##', '[CLS]', '[SEP]']
...
def _write_base(batch_tokens,id2label,prediction,batch_labels,wf,i):
    ...
    if token!="[PAD]" and token!="[CLS]" and token!="[SEP]": #and  not token.startswith("##") and true_l!="##":
        #
        #if predict=="##" and not token.startswith("##"):
        #    predict="O"
